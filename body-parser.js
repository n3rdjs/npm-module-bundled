...
var callSiteToString = __webpack_require__(4).callSiteToString
var eventListenerCount = __webpack_require__(4).eventListenerCount
...
lazyProperty(module.exports, 'callSiteToString', function callSiteToString () {
  ...
  return stack[0].toString ? toString : __webpack_require__(6)
})

lazyProperty(module.exports, 'eventListenerCount', function eventListenerCount () {
  return EventEmitter.listenerCount || __webpack_require__(7)
})
...
var toIdentifier = __webpack_require__(19)
...
var codes = __webpack_require__(15)
...
var onFinished = __webpack_require__(56)
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __webpack_require__(34); // Lazy load all encoding definitions.
...
module.exports = {
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(46).concat(__webpack_require__(47)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'gb18030': {
        type: '_dbcs',
        table: function() { return __webpack_require__(46).concat(__webpack_require__(47)) },
        gb18030: function() { return __webpack_require__(48) },
        encodeSkipVals: [0x80],
        encodeAdd: {'€': 0xA2E3},
    },
...
var Buffer = __webpack_require__(32).Buffer,
    Transform = __webpack_require__(53).Transform;
...
var typer = __webpack_require__(60)
