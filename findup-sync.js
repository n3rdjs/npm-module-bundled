...
var resolveDir = __webpack_require__(7);
var detect = __webpack_require__(22);
var mm = __webpack_require__(23);
...
var isExtglob = __webpack_require__(6);
var chars = { '{': '}', '(': ')', '[': ']'};
var strictRegex = /\\(.)|(^!|\*|[\].+)]\?|\[[^\\\]]+\]|\{[^\\}]+\}|\(\?[:!=][^\\)]+\)|\([^|]+\|[^\\)]+\))/;
var relaxedRegex = /\\(.)|(^!|[*?{}()[\]]|\(\?)/;
...
var homedir = __webpack_require__(9);
var path = __webpack_require__(4);
...
var expand = __webpack_require__(8);
var homedir = __webpack_require__(9);
var ini = __webpack_require__(16);
var prefix;
...
function tryNpmPath() {
  try {
    return fs.realpathSync(__webpack_require__(18).sync('npm'));
  } catch (err) {}
  return null;
}
...
const braces = __webpack_require__(25);
const picomatch = __webpack_require__(35);
...
const compile = __webpack_require__(28);
const expand = __webpack_require__(32);
...
const fill = __webpack_require__(29);
const utils = __webpack_require__(27);
...
const util = __webpack_require__(24);
const toRegexRange = __webpack_require__(30);
...
const isNumber = __webpack_require__(31);
...
picomatch.constants = __webpack_require__(39);
