...
const whatwgEncoding = __webpack_require__(3);
...
const iconvLite = __webpack_require__(4);
const supportedNames = __webpack_require__(29);
const labelsToNames = __webpack_require__(30);
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __webpack_require__(8); // Lazy load all encoding definitions.
...
module.exports = {
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(20).concat(__webpack_require__(21)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'gb18030': {
        type: '_dbcs',
        table: function() { return __webpack_require__(20).concat(__webpack_require__(21)) },
        gb18030: function() { return __webpack_require__(22) },
        encodeSkipVals: [0x80],
        encodeAdd: {'€': 0xA2E3},
    },
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(24).concat(__webpack_require__(25)) },
