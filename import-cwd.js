...
const importFrom = __webpack_require__(3);
...
module.exports = (fromDirectory, moduleId) => __webpack_require__(8)(resolveFrom(fromDirectory, moduleId));

module.exports.silent = (fromDirectory, moduleId) => {
	try {
		return __webpack_require__(8)(resolveFrom(fromDirectory, moduleId));
	} catch (_) {}
};
...
const Module = __webpack_require__(6);
