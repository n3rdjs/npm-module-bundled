...
var compatTranspiler = __webpack_require__(4);
var generator = __webpack_require__(10);
var optimizer = __webpack_require__(16);
var parser = __webpack_require__(11);
var _transform = __webpack_require__(9);
var _traverse = __webpack_require__(14);
var fa = __webpack_require__(36);
...
var compatTransforms = __webpack_require__(5);
var _transform = __webpack_require__(9);
...
module.exports = {
  // "dotAll" `s` flag
  dotAll: __webpack_require__(6),

  // Named capturing groups.
  namedCapturingGroups: __webpack_require__(7),

  // `x` flag
  xFlag: __webpack_require__(8)
};
...
var generator = __webpack_require__(10);
var parser = __webpack_require__(11);
var traverse = __webpack_require__(14);
...
var regexpTreeParser = __webpack_require__(12);
...
var unicodeProperties = __webpack_require__(13);
...
var NodePath = __webpack_require__(15);
...
var optimizationTransforms = __webpack_require__(18);
...
module.exports = {
  // \ud83d\ude80 -> \u{1f680}
  'charSurrogatePairToSingleUnicode': __webpack_require__(19),

  // \u0061 -> a
  'charCodeToSimpleChar': __webpack_require__(20),

  // /Aa/i -> /aa/i
  'charCaseInsensitiveLowerCaseTransform': __webpack_require__(21),

  // [\d\d] -> [\d]
  'charClassRemoveDuplicates': __webpack_require__(22),

  // a{1,2}a{2,3} -> a{3,5}
  'quantifiersMerge': __webpack_require__(23),

  // a{1,} -> a+, a{3,3} -> a{3}, a{1} -> a
  'quantifierRangeToSymbol': __webpack_require__(25),

  // [a-a] -> [a], [a-b] -> [ab]
  'charClassClassrangesToChars': __webpack_require__(26),

  // [a-de-f] -> [a-f]
  'charClassClassrangesMerge': __webpack_require__(27),

  // [0-9] -> [\d]
  'charClassToMeta': __webpack_require__(28),

  // [\d] -> \d, [^\w] -> \W
  'charClassToSingleChar': __webpack_require__(29),

  // \e -> e
  'charEscapeUnescape': __webpack_require__(30),

  // (ab|ab) -> (ab)
  'disjunctionRemoveDuplicates': __webpack_require__(31),

  // (a|b|c) -> [abc]
  'groupSingleCharsToCharClass': __webpack_require__(32),

  // (?:)a -> a
  'removeEmptyGroup': __webpack_require__(33),

  // (?:a) -> a
  'ungroup': __webpack_require__(34),

  // abcabcabc -> (?:abc){3}
  'combineRepeatingPatterns': __webpack_require__(35)
};
...
var NFA = __webpack_require__(37);
var DFA = __webpack_require__(39);

var nfaFromRegExp = __webpack_require__(41);
var builders = __webpack_require__(42);
...
var DFAMinimizer = __webpack_require__(40);
...
var NFA = __webpack_require__(37);
var NFAState = __webpack_require__(43);
