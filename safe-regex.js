...
const regexpTree = __webpack_require__(3);
...
var compatTransforms = __webpack_require__(6);
var _transform = __webpack_require__(10);
...
module.exports = {
  // "dotAll" `s` flag
  dotAll: __webpack_require__(7),

  // Named capturing groups.
  namedCapturingGroups: __webpack_require__(8),

  // `x` flag
  xFlag: __webpack_require__(9)
};
...
var generator = __webpack_require__(11);
var parser = __webpack_require__(12);
var traverse = __webpack_require__(15);
...
var regexpTreeParser = __webpack_require__(13);
...
var unicodeProperties = __webpack_require__(14);
...
var NodePath = __webpack_require__(16);
...
var optimizationTransforms = __webpack_require__(19);
...
module.exports = {
  // \ud83d\ude80 -> \u{1f680}
  'charSurrogatePairToSingleUnicode': __webpack_require__(20),

  // \u0061 -> a
  'charCodeToSimpleChar': __webpack_require__(21),

  // /Aa/i -> /aa/i
  'charCaseInsensitiveLowerCaseTransform': __webpack_require__(22),

  // [\d\d] -> [\d]
  'charClassRemoveDuplicates': __webpack_require__(23),

  // a{1,2}a{2,3} -> a{3,5}
  'quantifiersMerge': __webpack_require__(24),

  // a{1,} -> a+, a{3,3} -> a{3}, a{1} -> a
  'quantifierRangeToSymbol': __webpack_require__(26),

  // [a-a] -> [a], [a-b] -> [ab]
  'charClassClassrangesToChars': __webpack_require__(27),

  // [a-de-f] -> [a-f]
  'charClassClassrangesMerge': __webpack_require__(28),

  // [0-9] -> [\d]
  'charClassToMeta': __webpack_require__(29),

  // [\d] -> \d, [^\w] -> \W
  'charClassToSingleChar': __webpack_require__(30),

  // \e -> e
  'charEscapeUnescape': __webpack_require__(31),

  // (ab|ab) -> (ab)
  'disjunctionRemoveDuplicates': __webpack_require__(32),

  // (a|b|c) -> [abc]
  'groupSingleCharsToCharClass': __webpack_require__(33),

  // (?:)a -> a
  'removeEmptyGroup': __webpack_require__(34),

  // (?:a) -> a
  'ungroup': __webpack_require__(35),

  // abcabcabc -> (?:abc){3}
  'combineRepeatingPatterns': __webpack_require__(36)
};
...
var NFA = __webpack_require__(38);
var DFA = __webpack_require__(40);

var nfaFromRegExp = __webpack_require__(42);
var builders = __webpack_require__(43);
...
var DFAMinimizer = __webpack_require__(41);
...
var NFA = __webpack_require__(38);
var NFAState = __webpack_require__(44);
