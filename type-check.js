...
(function(){
  ...
  VERSION = '0.3.2';
  parseType = __webpack_require__(3);
  parsedTypeCheck = __webpack_require__(4);
...
(function(){
  ...
  ref$ = __webpack_require__(5), any = ref$.any, all = ref$.all, isItNaN = ref$.isItNaN;
  types = {
    Number: {
      typeOf: 'Number',
...
Obj = __webpack_require__(8);
Str = __webpack_require__(9);
Num = __webpack_require__(10);
id = function(x){
  return x;
};
